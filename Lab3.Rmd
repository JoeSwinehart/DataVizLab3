...
#it's all in the title to this chunk
...
#Patterns noticed: Midwest and West tend to produce more, Northeast less, and South much less.
```
...
ggplot(imported_honey_production, aes(year, priceperlb)) +
  ...
  labs(title = "Honey Prices per Pound from 1998 to 2012",
       ...
       x = "Year",
       y = "Price per pound") +
  scale_fill_continuous(name = "Number of States per unit")
